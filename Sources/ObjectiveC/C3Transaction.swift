...
extension MOACTransaction {
    public var objc: C3MOACTransaction {
		return C3MOACTransaction(self)
	}
}
@objc public class C3MOACTransaction: NSObject, SwiftContainer {
	...
	@objc public func mergedWithOptions(_ options: C3Options) -> C3MOACTransaction {
	...
	@objc public static func fromRaw(_ raw: Data) -> C3MOACTransaction? {
